...
void
RGB_LED_Write_Byte(uint8_t byte) {
    uint8_t i;
...
void
RGB_LED_Write_24Bits(uint8_t green, uint8_t red, uint8_t blue) {
...
***********************************************************************************************/
void
hsv_to_rgb(int h, int s, int v, float* R, float* G, float* B) {
